...
latex_documents = [
    ('index', 'Redisco.tex', u'Redisco Documentation', u'Sebastien Requiem', 'manual'),
]
...
texinfo_documents = [
    ('index', 'Redisco', u'Redisco Documentation', u'Sebastien Requiem', 'Redisco', 'One line description of project.', 'Miscellaneous'),
]
